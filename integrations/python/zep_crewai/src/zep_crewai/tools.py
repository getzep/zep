...
class AddGraphDataInput(BaseModel):
    ...
    data_type: str = Field(
        default="text",
        description="Type of data: 'text', 'json', or 'message'"
    )
    ...
    def _run(self, query: str, limit: int = 10, scope: str = "edges") -> str:
        ...
        try:
            ...
            for i, result in enumerate(results, 1):
                formatted += f"{i}. [{result['type'].upper()}] {result['content']}\n"
    ...
    def _run(self, data: str, data_type: str = "text") -> str:
        ...
        try:
            ...
            if self._graph_id:
                ...
                success_msg = f"Successfully added {data_type} data to user '{self._user_id}' memory"
